...
* test ([e6b646a](https://github.com/BlueGradientHorizon/revanced-patches/commit/e6b646ad5f287f109a4876657768036339cf7215))

# [2.188.0-dev.7](https://github.com/BlueGradientHorizon/revanced-patches/compare/v2.188.0-dev.6...v2.188.0-dev.7) (2023-08-27)


### Bug Fixes

* test ([dd8f983](https://github.com/BlueGradientHorizon/revanced-patches/commit/dd8f983f2f89716cedde2096a49e786ec991957a))
...
* actually return error from CustomCDN patch to show output ([4c2ae52](https://github.com/BlueGradientHorizon/revanced-patches/commit/4c2ae523a13fddb5eab3c5c275ca7763bcf54dd3))
...
* allow using `PreferenceScreen` outside of current module ([fe94013](https://github.com/BlueGradientHorizon/revanced-patches/commit/fe94013a2235953b32fed6e0710a252698a264b3))
* **Client spoof:** Remove exception from option ([9c69f87](https://github.com/BlueGradientHorizon/revanced-patches/commit/9c69f876902496c101eac295e581c15e02bfaf29))
* **Enable android debugging:** Update patch description ([#2869](https://github.com/BlueGradientHorizon/revanced-patches/issues/2869)) ([d9f0d08](https://github.com/BlueGradientHorizon/revanced-patches/commit/d9f0d08498662e7aa18edb5201a5d60f3738e4e4))
* improve wording ([26f9b05](https://github.com/BlueGradientHorizon/revanced-patches/commit/26f9b0514fda9434b2a36d2f9e5ad6a4f5bb94bd))
* **Reddit is Fun - Spoof client:** Use a more convincing user agent ([236a18f](https://github.com/BlueGradientHorizon/revanced-patches/commit/236a18f9356cede156417c0d55a876d25a98cd4d))
* remove newline ([545388b](https://github.com/BlueGradientHorizon/revanced-patches/commit/545388b3b21cabb485c4d2025756c48984548d6b))
* Revert previous release ([ed24a20](https://github.com/BlueGradientHorizon/revanced-patches/commit/ed24a201a9fbe08dd6694582d0ab08ced8ad026a))
* **Tiktok - Show seekbar:** Bump compatibility ([#2737](https://github.com/BlueGradientHorizon/revanced-patches/issues/2737)) ([08413bd](https://github.com/BlueGradientHorizon/revanced-patches/commit/08413bdc97aef892f7372c585d1d792eb95e30f4))
* **YouTube - Client spoof:** Adjust spoof signature settings description ([#2760](https://github.com/BlueGradientHorizon/revanced-patches/issues/2760)) ([f71d893](https://github.com/BlueGradientHorizon/revanced-patches/commit/f71d8937663fdbfc93d8e3ce1cdb47e1667554f0))
* **YouTube Music - Remove upgrade button:** Remove the correct navigation bar item ([fd3813f](https://github.com/BlueGradientHorizon/revanced-patches/commit/fd3813f66ededdae1e52bf021a3de9d818f65096))


### Features

* Add `Override certificate pinning` patch ([#2781](https://github.com/BlueGradientHorizon/revanced-patches/issues/2781)) ([94ed738](https://github.com/BlueGradientHorizon/revanced-patches/commit/94ed738515aa6e1a1d346b85b54805e68e36f94c))
* **Change package name:** Append `.revanced` to package name by default ([#2750](https://github.com/BlueGradientHorizon/revanced-patches/issues/2750)) ([e83e62f](https://github.com/BlueGradientHorizon/revanced-patches/commit/e83e62fc2400caf1c5179d25e0ac4fbd51ddba00))
* **Duolingo:** Add `Unlock Duolingo Super` patch ([#2862](https://github.com/BlueGradientHorizon/revanced-patches/issues/2862)) ([61a7533](https://github.com/BlueGradientHorizon/revanced-patches/commit/61a7533136f38d7a308e31c9f250baad00515d6a))
* Exclude `Custom branding` patch by default ([d6de957](https://github.com/BlueGradientHorizon/revanced-patches/commit/d6de957f4efce11d9a709d4c8f500b039166fc2f))
* **Lightroom:** Add `Disable mandatory login` patch ([#2738](https://github.com/BlueGradientHorizon/revanced-patches/issues/2738)) ([896a713](https://github.com/BlueGradientHorizon/revanced-patches/commit/896a71308f1084d7f941c5b59610e40ea5d53009))
* **Lightroom:** Add `Unlock premium` patch ([#2740](https://github.com/BlueGradientHorizon/revanced-patches/issues/2740)) ([e18a9bc](https://github.com/BlueGradientHorizon/revanced-patches/commit/e18a9bcb50705d374ccbf03cd6ab9a140a2f23ec))
* **Nova Launcher:** Remove `Unlock prime` patch ([bbde91c](https://github.com/BlueGradientHorizon/revanced-patches/commit/bbde91cf9df4b410a34147bbe5f359e39a71ad4c))
* Publicize resource utility functions ([20aff26](https://github.com/BlueGradientHorizon/revanced-patches/commit/20aff26784296517257ea19d66ffd3bdfe6b06fa))
* **Solid Explorer:** Add `Remove file size limit` patch ([01c617d](https://github.com/BlueGradientHorizon/revanced-patches/commit/01c617d94e58b30bbffb3426fcfa55b8979962bd))
* **Strava:** Add `Subscription features` patch ([#2872](https://github.com/BlueGradientHorizon/revanced-patches/issues/2872)) ([387eb29](https://github.com/BlueGradientHorizon/revanced-patches/commit/387eb29e7ed45169c89a03513af64104d0082f28))
* **Tasker:** Remove `Unlock trial` patch ([8354a87](https://github.com/BlueGradientHorizon/revanced-patches/commit/8354a879cfc6028820e2bb0e01d6f607e145c0f6))
* Use an extension property to create new exception when failing to resolve a fingerprint ([47eac14](https://github.com/BlueGradientHorizon/revanced-patches/commit/47eac14f039dc466c1957470d82255bfa2c06ff0))
* **YouTube - Debug:** Logging of layout proto buffer strings ([#2759](https://github.com/BlueGradientHorizon/revanced-patches/issues/2759)) ([189f719](https://github.com/BlueGradientHorizon/revanced-patches/commit/189f719720551f36c6e006c45558fe5ae46ca4f8))
* **YouTube - External downloads:** Recommend Seal instead of PowerTube ([#2803](https://github.com/BlueGradientHorizon/revanced-patches/issues/2803)) ([082e067](https://github.com/BlueGradientHorizon/revanced-patches/commit/082e067338026d05046ed5f398a1261aa20d3cb3))
* **YouTube - Hide video action buttons:** Hide individual action buttons ([#2723](https://github.com/BlueGradientHorizon/revanced-patches/issues/2723)) ([220f694](https://github.com/BlueGradientHorizon/revanced-patches/commit/220f694b12e7ed013753c8215d181936ab2205c3))
* **YouTube Music - Exclusive audio playback:** Support latest version ([0861991](https://github.com/BlueGradientHorizon/revanced-patches/commit/0861991cfbdfa977713f1f1f4ee8a0a5fd3f939e))
* **YouTube Music:** Add `Permanent repeat` patch ([#2722](https://github.com/BlueGradientHorizon/revanced-patches/issues/2722)) ([506d49c](https://github.com/BlueGradientHorizon/revanced-patches/commit/506d49c82a68faee25aede8194e7884191c0f271))
* **YouTube Music:** Add `Permanent Shuffle` patch ([#2730](https://github.com/BlueGradientHorizon/revanced-patches/issues/2730)) ([86a271c](https://github.com/BlueGradientHorizon/revanced-patches/commit/86a271cd7cc3d1d2a11ff9ebe962574368b93f4f))
* **YouTube:** Add `Alternative thumbnails` patch ([#2834](https://github.com/BlueGradientHorizon/revanced-patches/issues/2834)) ([8a4277c](https://github.com/BlueGradientHorizon/revanced-patches/commit/8a4277c486d995f57cde3a56274979c4a7b42bf6))
* **YouTube:** Add `Custom player overlay opacity` patch ([#2721](https://github.com/BlueGradientHorizon/revanced-patches/issues/2721)) ([2622b00](https://github.com/BlueGradientHorizon/revanced-patches/commit/2622b008ab78b15aa3c28a13b38e63041f29c9ea))
* **YouTube:** Add `Enable tablet layout` patch ([c89b2aa](https://github.com/BlueGradientHorizon/revanced-patches/commit/c89b2aa26125d302079b5cf522f3b6c9fbe1257a))
* **YouTube:** Support version `18.29.38` ([c1b9eef](https://github.com/BlueGradientHorizon/revanced-patches/commit/c1b9eefa280b980d08a571e1ce205dc71ccde3b6))
* **YouTube:** Support version `18.32.39` ([7b503e2](https://github.com/BlueGradientHorizon/revanced-patches/commit/7b503e2336dd4d330b651bf7c168d95a38e8c777))
